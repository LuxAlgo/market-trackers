...
export function makeCongressHearing(overrides: Partial<CongressHearing> = {}): CongressHearing {
  return {
    id: "CHRG-119hhrg90001",
    packageId: "CHRG-119hhrg90001",
    title: "OVERSIGHT OF EXAMPLE DATA PRACTICES",
    chamber: "house",
    docClass: "HHRG",
    congress: 119,
    session: 1,
    ...
    witnesses: ["Jane Q. Witness, Director, Example Bureau"],
    ...
    provenance: makeProvenance("govinfo-hearings"),
    ...overrides,
  };
}

export function makeFedCommunication(overrides: Partial<FedCommunication> = {}): FedCommunication {
  return {
    ...
    venue: "At the Example Economic Luncheon, Example City",
    url: "https://www.federalreserve.gov/newsevents/speech/example20260805a.htm",
    videoUrl: null,
    note: null,
    provenance: makeProvenance("federalreserve"),
    ...overrides,
  };
}

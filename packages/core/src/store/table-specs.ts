...
export const CONGRESS_HEARINGS_TABLE = datasetTable(
  "congress_hearings",
  [
    { name: "package_id", type: "text" },
    { name: "title", type: "text" },
    { name: "chamber", type: "text", nullable: true },
    { name: "doc_class", type: "text", nullable: true },
    { name: "congress", type: "integer" },
    { name: "session", type: "integer", nullable: true },
    { name: "held_date", type: "text" },
    { name: "citation", type: "text", nullable: true },
    { name: "committees", type: "json" },
    { name: "witnesses", type: "json" },
    { name: "member_bioguide_ids", type: "json" },
    { name: "detail_url", type: "text" },
    { name: "html_url", type: "text", nullable: true },
    { name: "pdf_url", type: "text", nullable: true },
  ],
  [
    { name: "idx_congress_hearings_congress", columns: ["congress"] },
    { name: "idx_congress_hearings_held_date", columns: ["held_date"] },
    { name: "idx_congress_hearings_chamber", columns: ["chamber"] },
  ],
);

export const FED_COMMUNICATIONS_TABLE = datasetTable(
  "fed_communications",
  [
    { name: "type", type: "text" },
    { name: "date", type: "text" },
  ...
  [
    { name: "idx_fed_communications_date", columns: ["date"] },
    { name: "idx_fed_communications_type", columns: ["type"] },
    { name: "idx_fed_communications_speaker", columns: ["speaker"] },
  ],
);
...
export const V4_TABLES: TableSpec[] = [CONGRESS_HEARINGS_TABLE, FED_COMMUNICATIONS_TABLE];
...
export const DATASET_TABLES: TableSpec[] = [
  ...
  FEC_CANDIDATES_TABLE,
  FEC_CONTRIBUTIONS_TABLE,
  CONGRESS_HEARINGS_TABLE,
  FED_COMMUNICATIONS_TABLE,
];

export const ALL_TABLES: TableSpec[] = [...V1_TABLES, ...V2_TABLES, ...V3_TABLES, ...V4_TABLES];

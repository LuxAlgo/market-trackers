/**
 * The one seam between LuxAlgo Market Trackers and its databases. SQL in the store layer is
 ...
 *   - "market-trackers.db", "./data/market-trackers.db", ":memory:", "sqlite:path" → SQLite

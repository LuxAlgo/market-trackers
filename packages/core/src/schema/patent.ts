...
/**
 * One granted US patent from PatentsView's bulk grant tables, published on
 * the USPTO Open Data Portal (a free API key is required by the provider).
 * Assignee→ticker mapping is best-effort via the curated public-company
 * map; unmapped assignees keep `tickers: []`.
 */

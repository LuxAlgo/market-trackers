...
- **Published data dumps** (the JSON files exported by `docket export` and published to the
  `docket-data` repository): [CC0 1.0 Universal](DATA-LICENSE).
...
The dumps contain facts from public records, normalized; Docket adds no editorial content to

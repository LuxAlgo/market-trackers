...
Docket runs locally, holds no credentials beyond optional free-tier API keys the user supplies,
...
[GitHub's private vulnerability reporting](https://github.com/LuxAlgo/docket/security/advisories/new)
